                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('citizen.reports.show', $report) }}" title="Voir le détail" class="p-1.5 rounded-lg text-gray-400 hover:text-green-600 hover:bg-green-50 transition inline-flex">
