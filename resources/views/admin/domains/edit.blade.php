        ...
        <form method="POST" action="{{ route('admin.domains.update', $domain) }}" class="space-y-5">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="3"
                          class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-400">{{ old('description', $domain->description) }}</textarea>
            </div>
