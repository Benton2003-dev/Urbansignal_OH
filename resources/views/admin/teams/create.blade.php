    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <form method="POST" action="{{ route('admin.teams.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <select name="domain_id" required class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 @error('domain_id') border-red-400 @enderror">
